...
# 📖 [Admissions Review <a name="about-project"></a>

\*\*[Admissions Review] is a self review project of the Microverse Admission trial projects
...
```sh
  ...
  git clone <https://github.com/Kevin-Mena/review.git>
...
Feel free to check the [issues page](https://github.com/Kevin-Mena/review/issues).
